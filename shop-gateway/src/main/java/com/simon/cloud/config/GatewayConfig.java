package com.simon.cloud.config;
...
public class GatewayConfig {
    ...
    public GatewayConfig(ObjectProvider<List<ViewResolver>>
...
//        GatewayRuleManager.loadRules(rules);
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api1 = new ApiDefinition("product_api1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{ // 以/product-serv/product/api1 开头的请求
